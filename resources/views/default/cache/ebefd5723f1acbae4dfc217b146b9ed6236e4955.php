                ...
                <div id="navigation_user">
                    <div class="body_width_limit clearfix">
                        <a ng-show="+user.group" class="<?php if( !$user->group ): ?>ng-hide <?php endif; ?>"
                           href="/menu.user.php" ng-bind="user.login"><?php echo e($user->login); ?></a>
                        ...
                        <a ng-hide="+user.group" class="ng-hide"
                           href="/login.php?return=<?php echo e(URL); ?>" ng-bind="translates.auth"><?= __('Авторизаци') ?></a>
                        <a ng-hide="+user.group" class="ng-hide"
                           href="/reg.php?return=<?php echo e(URL); ?>" ng-bind="translates.reg"><?= __('Регистрация') ?></a>
